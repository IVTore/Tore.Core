...
/**———————————————————————————————————————————————————————————————————————————
  ...
  TASK: GET: Returns if program is running in a docker container.   </summary>
————————————————————————————————————————————————————————————————————————————*/
...
————————————————————————————————————————————————————————————————————————————*/
public static void          chk(object arg, 
                                string inf, 
...
————————————————————————————————————————————————————————————————————————————*/
public static Stl   loadCryptoJsonFile( string  fileSpec,
                                        string  encKey,
                                        string  xorKey,
                                        string  strip = "-"){
byte[]  key;
...
/**———————————————————————————————————————————————————————————————————————————
  ...
  INFO: Encrypted files are marked with string "TORECJF:1:".        </summary>
————————————————————————————————————————————————————————————————————————————*/
public static void  saveCryptoJsonFile( string  fileSpec,
                                        Stl     src,
                                        string  encKey,
                                        string  xorKey,
                                        string  strip    = "-"){
